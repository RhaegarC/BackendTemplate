namespace Tmp.Tests.TestSupport;
...
/// <summary>
/// A <c>TmpContext</c> with the audit interceptor attached, wired the way the application
...
internal sealed class AuditHarness : IDisposable
{
    ...
    public AuditHarness(FakeUserContext? user = null)
    {
        ...
        Context = _scope.ServiceProvider.GetRequiredService<TmpContext>();
    }
